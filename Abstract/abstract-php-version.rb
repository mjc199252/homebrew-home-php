class AbstractPhpVersion < Formula
  ...
  module Php71Defs
    PHP_SRC_TARBALL = "https://github.com/php/php-src/archive/php-7.1.33.tar.gz".freeze
    PHP_GITHUB_URL  = "https://github.com/php/php-src/archive/php-7.1.33.tar.gz".freeze
